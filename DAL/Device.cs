...
namespace Maticsoft.DAL
{
	...
	public partial class Device
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Device_Id", "Device"); 
		}
		...
		public bool DeleteList(string Device_Idlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Device ");
			strSql.Append(" where Device_Id in ("+Device_Idlist + ")  ");
		...
		public Maticsoft.Model.Device GetModel(int Device_Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Device_Id,Name,Type,Memo from Device ");
			strSql.Append(" where Device_Id=@Device_Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Device_Id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Device_Id,Name,Type,Memo ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Device_Id,Name,Type,Memo ");
			strSql.Append(" FROM Device ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.Device_Id desc");
			}
